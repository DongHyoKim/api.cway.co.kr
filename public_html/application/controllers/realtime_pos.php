...
class Realtime_pos extends CT_Controller {
    ...
    {	  
        ...
        writeLog("[{$sLogFileId}] univcode=" .json_encode($univcode)." saletotal_member=".json_encode($saletotal_member), $sLogPath, $bLogable);
        ...
        echo json_encode($json_array);
        writeLog("[{$sLogFileId}] status=" .json_encode($json_array['status'])." totalmileage=".json_encode($json_array['totalmileage']), $sLogPath, $bLogable);
